...
```{r}
#| fig-align: center
#| fig-alt: "MMR vaccination over time"
mmr_line_df |> mmr_vaccination_over_time_chart_bar(state_title)
```


```{r}
#| fig-alt: "MMR vaccination comparison"
...
typst_list <- state_policies |>
  mutate(
    ...
    list_item = glue(
      '#list(marker: image("assets/{arrow}", width: 23pt, alt: "{arrow_alt}"))[',
...
#box(
  ...
  [
    #grid(
      ...
      gutter: 0.1em,
      align: horizon,
      [#image("assets/coins.svg", alt: "Several coins stacked on top of each other")],
      [#text(
        font: "Gentona",
        size: 11pt,
        fill: white
