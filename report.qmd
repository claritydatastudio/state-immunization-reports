...
#box(
  ...
  #grid(
    ...
    #text(
      ...
      Vaccines can help prevent costly outbreaks. Even a single case of measles triggers an   outbreak response estimated to cost more than 
      #text(fill: rgb("#f1c400"))[US\$224K], plus #text(fill: rgb("#f1c400"))[US\$16K] in costs for every additional case.
    ]
  ]
